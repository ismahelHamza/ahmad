...
<div class="w-full h-full bg-transparent col-span-5 overflow-auto">
        <div class="w-[90%] p-2 bg-[#242424] rounded-xl mx-auto mt-5 flex items-center">
               <div class="h-[90%] w-full border-r p-2 border-slate-400 ml-2 mr-2">
                    <p class="text-gray-400">Location</p>
                      <select name="" id="city" class="bg-[#1A1A1A] mt-2 p-2 px-2 rounded">
                          <option value="">Hawler</option>
                          <option value="">slemaniah</option>
                          <option value="">Dhok</option>
                      </select>
               </div>
               <div class="h-[90%] w-full border-r p-2 border-slate-400 ml-2 pr-3">
                    <p class="text-gray-400">Type </p>
                      <select name="" id="type" class="bg-[#1A1A1A] mt-2 p-2 px-2 rounded">
                          <option value="">Apartment</option>
                          <option value="">House</option>
                      </select>
               </div>
               <div class="w-full h-[90%]  p-2 border-slate-400 ml-2 pr-3">
                    <p class="text-gray-400">Room </p>
                      <select name="" id="room" class="bg-[#1A1A1A] mt-2 p-2 px-2 rounded">
               ...
               <button class="search-btn mr-6 border h-[40px] px-4 rounded text-green-300 border-green-300 transition-all hover:bg-green-300 hover:text-black">search</button>
        </div>
       <div class="card-place w-full mt-5 p-5 flex gap-2 flex-wrap relative justify-center">
